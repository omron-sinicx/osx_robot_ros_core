...
class URScriptRelay():
    ...
    def __init__(self):
        ...
        self.read_templates()
        s = rospy.Service('osx_skills/sendScriptToUR', osx_msgs.srv.sendScriptToUR, self.srv_callback)
    ...
    def srv_callback(self, req):
        ...
        # Moves outwards in a spiral, then moves downwards while moving in a spiral
            ...
            program = ""
            program_file = open(os.path.join(self.rospack.get_path("osx_examples"), "scripts/script_command", "move_back_forth_5cm.script"), 'rb')
    ...
    def read_template(self, filename):
        program_template_file = open(os.path.join(self.rospack.get_path("osx_skills"), "src/urscript", filename), 'rb')
...
if __name__ == '__main__':
    ...
    rospy.init_node('osx_urscript_construction_node')
