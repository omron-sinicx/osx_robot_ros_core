...
public:
  ...
  void setupUi(QWidget *osxSetupForm) {
    if (osxSetupForm->objectName().isEmpty())
      osxSetupForm->setObjectName(QStringLiteral("osxSetupForm"));
    osxSetupForm->resize(385, 366);
    verticalLayout = new QVBoxLayout(osxSetupForm);
    verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
    group_activation = new QHBoxLayout();
    group_activation->setObjectName(QStringLiteral("group_activation"));
    button_activate_ros_control = new QPushButton(osxSetupForm);
    ...
    button_robots_home = new QPushButton(osxSetupForm);
    ...
    cameras_group = new QGroupBox(osxSetupForm);
    ...
    a_bot_group = new QGroupBox(osxSetupForm);
    ...
    b_bot_group = new QGroupBox(osxSetupForm);
    ...
    base_plate_fixation_group = new QGroupBox(osxSetupForm);
    ...
    tool_group_box = new QGroupBox(osxSetupForm);
    ...
    retranslateUi(osxSetupForm);

    QMetaObject::connectSlotsByName(osxSetupForm);
  } // setupUi

  void retranslateUi(QWidget *osxSetupForm) {
    osxSetupForm->setWindowTitle(
        QApplication::translate("osxSetupForm", "Form", Q_NULLPTR));
    button_activate_ros_control->setText(QApplication::translate(
        "osxSetupForm", "Activate UR ROS control", Q_NULLPTR));
    button_robots_home->setText(
        QApplication::translate("osxSetupForm", "Robots go home", Q_NULLPTR));
    a_bot_group->setTitle(
        QApplication::translate("osxSetupForm", "a_bot", Q_NULLPTR));
    button_home_a_bot->setText(
        QApplication::translate("osxSetupForm", "Home", Q_NULLPTR));
    button_open_gripper_a->setText(
        QApplication::translate("osxSetupForm", "Open", Q_NULLPTR));
    button_close_gripper_a->setText(
        QApplication::translate("osxSetupForm", "Close", Q_NULLPTR));
    b_bot_group->setTitle(
        QApplication::translate("osxSetupForm", "b_bot", Q_NULLPTR));
    ...
    base_plate_fixation_group->setTitle(
        QApplication::translate("osxSetupForm", "Base plate", Q_NULLPTR));
    button_open_base_fixation->setText(
        QApplication::translate("osxSetupForm", "Open", Q_NULLPTR));
    button_close_base_fixation->setText(
        QApplication::translate("osxSetupForm", "Close", Q_NULLPTR));
    tool_group_box->setTitle(
        QApplication::translate("osxSetupForm", "Tools", Q_NULLPTR));
    tool_header_vac->setText(
        QApplication::translate("osxSetupForm", "Vac", Q_NULLPTR));
    button_a_bot_m4_pick_screw->setText(
        QApplication::translate("osxSetupForm", "a_bot", Q_NULLPTR));
    button_b_bot_m4_pick_screw->setText(
        QApplication::translate("osxSetupForm", "b_bot", Q_NULLPTR));
    tool_row_m4->setText(
        QApplication::translate("osxSetupForm", "M4", Q_NULLPTR));
    button_loosen_m4_1s->setText(
        QApplication::translate("osxSetupForm", "1s", Q_NULLPTR));
    button_a_bot_m4_equip->setText(
        QApplication::translate("osxSetupForm", "a_bot", Q_NULLPTR));
    label_tool_m3_alive->setText(
        QApplication::translate("osxSetupForm", "\342\235\214", Q_NULLPTR));
    button_b_bot_m4_unequip->setText(
        QApplication::translate("osxSetupForm", "b_bot", Q_NULLPTR));
    tool_header_alive->setText(
        QApplication::translate("osxSetupForm", "Alive", Q_NULLPTR));
    tool_header_loosen->setText(
        QApplication::translate("osxSetupForm", "Unscr.", Q_NULLPTR));
    tool_row_m3->setText(
        QApplication::translate("osxSetupForm", "M3", Q_NULLPTR));
    button_b_bot_m4_equip->setText(
        QApplication::translate("osxSetupForm", "b_bot", Q_NULLPTR));
    button_tighten_m4_5s->setText(
        QApplication::translate("osxSetupForm", "5s", Q_NULLPTR));
    button_a_bot_m4_unequip->setText(
        QApplication::translate("osxSetupForm", "a_bot", Q_NULLPTR));
    tool_header_pick->setText(
        QApplication::translate("osxSetupForm", "Pick", Q_NULLPTR));
    tool_header_equip->setText(
        QApplication::translate("osxSetupForm", "Equip", Q_NULLPTR));
    label_tool_m3_vac->setText(
        QApplication::translate("osxSetupForm", "\342\236\226", Q_NULLPTR));
    tool_header_unequip->setText(
        QApplication::translate("osxSetupForm", "Uneq.", Q_NULLPTR));
    ...
    tool_row_padless_m4->setText(
        QApplication::translate("osxSetupForm", "P-M4", Q_NULLPTR));
    tool_header_tighten->setText(
        QApplication::translate("osxSetupForm", "Screw", Q_NULLPTR));
    tool_row_m2s->setText(
        QApplication::translate("osxSetupForm", "M2s", Q_NULLPTR));
...
namespace Ui {
class osxSetupForm : public Ui_osxSetupForm {};
} // namespace Ui
