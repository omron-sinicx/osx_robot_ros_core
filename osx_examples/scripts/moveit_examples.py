...
def main():
    ...
    osx.a_bot.move_joints(joint_pose_goal=joint_pose_goal, speed=0.3)
    ...
    osx.a_bot.go_to_pose_goal(pose_goal_stamped=pose_goal, speed=0.3)
    ...
    # Move 10cm downward
    osx.a_bot.move_lin_rel(relative_translation=[0, 0, -0.1], relative_to_robot_base=True, speed=0.3)
    ...
    # Move 10cm upward
    osx.a_bot.move_lin_rel(relative_translation=[-0.1, 0, 0], relative_to_tcp=True, speed=0.3)
    ...
    osx.a_bot.move_lin_rel(relative_translation=[0.1, 0, 0], speed=0.3)
