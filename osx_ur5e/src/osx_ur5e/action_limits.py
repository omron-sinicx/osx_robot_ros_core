...
class DeltaActionLimiter:
    ...
    def clip(self, delta_translation, delta_orientation, dt,
        ...
        clipped_translation, self._prev_linear_velocity = self._clip_axis(
        ...
        clipped_orientation, self._prev_angular_velocity = self._clip_axis(
    ...
    def _clip_axis(delta, dt, max_delta, max_velocity, max_acceleration, prev_velocity):
        ...
        if max_acceleration is not None:
            ...
            velocity = np.clip(velocity, prev_velocity - dv_max, prev_velocity + dv_max)
